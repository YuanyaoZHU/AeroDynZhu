...
SUBROUTINE CalculateOutput( Time, InputData, p, x, xd, z, OtherStates, y, m, FillWrOut, ErrStat, ErrMsg )
     ...
     ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::1'        !zhu
      !-----------------------------------------------------------------------
      ...
      CALL SetErrStat( TmpErrStat, TmpErrMsg, ErrStat, ErrMsg, RoutineName )
      IF ( ErrStat >= AbortErrLev ) RETURN
        ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::2'
      ...
      ELSE
         ...
         ENDDO
      ENDIF
         ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::3'
      ...
      END SELECT
         ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::4'
...
!!!
      ...
      IF ( p%RotateWindBox ) THEN
         ...
         ENDDO
      ENDIF
     ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::5'
     ...
     ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::6'
   ...
   IF (ALLOCATED(PositionXYZprime)) DEALLOCATE(PositionXYZprime)
     ...
     ! zhu:2022年2月18日修改，原因是降低输出频率提高计算效率    write(*,*)'CalculateOutput::flag::7'
